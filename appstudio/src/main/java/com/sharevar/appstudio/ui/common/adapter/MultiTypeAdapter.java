...
package com.sharevar.appstudio.ui.common.adapter;
...
import static com.sharevar.appstudio.ui.common.adapter.Preconditions.checkNotNull;
...
public class MultiTypeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   */
  public <T> void register(@NonNull Class<? extends T> clazz, @NonNull
   ...
   * @seev ItemViewBinder#onViewAttachedToWindow(ViewHolder)
   */
  @Override @SuppressWarnings("unchecked")
