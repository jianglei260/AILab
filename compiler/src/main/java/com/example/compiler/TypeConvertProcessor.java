...
@AutoService(com.example.compiler.TypeConvertProcessor.class)
public class TypeConvertProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        for (Element element : roundEnvironment.getElementsAnnotatedWith(Converter.class)) {
            if (element instanceof TypeElement) {
                ...
                Converter widget = classElement.getAnnotation(Converter.class);
                String name = null;
